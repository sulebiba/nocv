...
?>
   <img src="users/<?php echo $Profile; ?>"width="100%"height="410px"> 
    ...
    <tr>
        ...
        if(isset($_SESSION['nocv_id'])){
        if($nocv_id==$nocv_id2){
         echo "<th class='col-sm-3 text-center'><b id='greeen'><br><br>Edit my Profile:</b></th><th class='col-sm-3'><br><br><a href='edit.php?nocv_id=$nocv_id' class='btn btn-primary glyphicon glyphicon-pencil'>Edit</a></th>";
}
}?>
     </tr>
    <tr>
        ...
        echo "<th class='col-sm-3 text-center'><b id='greeen'><br><br></b></th><th class='col-sm-3'><br><br><a href='nocv_id.php?nocv_id=$nocv_id'class='btn btn-primary glyphicon glyphicon-user'>MyPageLink</a></th></tr>";
        
         echo "<th class='col-sm-3 text-center'><b id='greeen'><br><br></b></th><th class='col-sm-3'><br><br><a href='my_messages.php?nocv_id=$nocv_id'class='btn btn-primary glyphicon glyphicon-envelope'>INBOX($number)</a></th></tr>";
         
         echo "<tr><th class='col-sm-3 text-center'><b id='greeen'><br><br></th><th class='col-sm-3'><br><a href='my_invites.php?nocv_id=$nocv_id'class='btn btn-primary glyphicon glyphicon-envelope'>INVITES($numberz)</a></th></tr>";
    ...
    if(isset($_SESSION['nocv_id'])){
    if($nocv_id==$nocv_id2){
    echo "<tr><form action='uploads.php'><input type='submit' name='submit'value='upload pic/audio/video'></form></tr>";
} 
}?>
...
echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
  ...
  <div class='small'><font size='3' align='center'>
  <a href='single_post.php?upload1=$upload1'>comments($number)</a></font></div> 
</div>
";         
}
else if($end=='mp4'){
...
"; 
    ...
    echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
<a href='single_post.php?upload1=$upload1'><img src='userspic/$upload1' height='300px'></a>  
  <div class='small'><font size='3' align='center'><a href='single_post.php?upload1=$upload1'>comments($number)</a></font></div> 
</div>
"; 
}
} 
...
echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
  ...
  <div class='small'><font size='3' align='center'><a href='single_post.php?upload1=$uploads1'>comments($number)</a></font></div> 
</div>
";                     
}
else if($end =='mp4'){
    echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
   <video controls='controls'width='100%' height='240'>
   <source src='userspic/$uploads1' type='video/mp4' class='img-responsive>
   </video> 
  <div class='small'><font size='3' align='center'><a href='single_post.php?upload1=$uploads1'>comments($number)</a></font></div> 
</div>
"; 
     ...
     echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
<a href='single_post.php?upload1=$uploads1'><img src='userspic/$uploads1' class='img-res' height='300px'></a>  
  <div class='small'><font size='3' align='center'>comments($number)</font></div> 
</div>
"; 
}
}
