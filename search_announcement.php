...
<img src='users/$profile' class='img-res' height='250px'> 
  <div class='small'><font size='2'align='center'><b>$name</b><br><b>$nunu State</b></font>
  <br><a href='search_announcement.php?nocvi_id=$nocv_id&start_chat=$sendiv&chat=$chats'><h4 align='left'><div class='btn btn-primary'>Send an Invite</div></h4></a><a href='contact_member.php?nocvi_id=$nocv_id'><h4 align='right'><div id='move' class='btn btn-warning'>Send a DM</div></h4></a></div>  
</div></div>  
</div>";
...
header("Location:search_announcement.php?forum_id=$invite");
ob_end_flush();
