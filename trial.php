...
<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    ...
    <h4 align="center" id="header"><b><font face='Algerian'>Our Own Country Of Jobs</font></b></h4> 
    ...
    <div class="box">
      <div class="box-header">
        <center>
          ...
          <form method="post" align="center" id="myForm" action="trial.php">
          <div class="form-group">
              <label>Email</label>
              <input type="text" class="form-control" name="email"placeholder="Enter your email address" id="couponCode" required>
              </div>
