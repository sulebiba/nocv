...
?>
   <img src="users/<?php echo $Profile; ?>"width="100%"height="410px"> 
    ...
    <tr>
         <th class="col-sm-3 text-center"><b id="greeen"><br><br>FORUM:</b></th><th class="col-sm-3"><br><br><?php echo $name; ?></th>
     </tr>
    
    <tr>
            <th class='col-sm-3 text-center'><b id='greeen'><br><br></b></th><th class='col-sm-3'><br><br>
            <?php
            if(isset($_GET['nocv_id'])){
                $nocv_id=$_GET['nocv_id'];
            
            ?>
            <a href='contact_user.php?nocv_id=<?php echo $nocv_id; ?>'class='btn btn-primary glyphicon glyphicon-envelope'>SendMessage</a></th>
        <?php } ?>
     </tr>
...
$select2=mysqli_query($db,"SELECT * FROM uploads WHERE nocv_id='$nocv_id2' ORDER BY 1 DESC LIMIT 0,100")or die(mysqli_error($db));
...
<a href='single_post.php?upload1=$uploads1'><audio controls='controls'>
...
";             
   ...
   echo"<div class='col-lg-3 col-md-3 col-sm-12 col-xs-12'>
<a href='single_post.php?upload1=$uploads1'><video controls='controls'width='100%' height='240'>
