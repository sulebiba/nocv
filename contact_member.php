...
<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    ...
    <h3 align="center" id="header2"><b id="country">Send a message to your member<br><div id="truth">(Messages sent here should be related to your Skill / Talent)</div></b></h3> 
      ...
      <div class="box-header">
        <center>
          ...
          <div class="form-group">
              <label>NocvId:</label>
              <input type="text" class="form-control" name="phone" placeholder="Enter your NocvId" value="<?php if(isset($_SESSION['nocv_id'])){
    $baby=$_SESSION['nocv_id']; echo $baby;
              
} ?>" id="phone"required>
              </div>
              <div class="form-group">
              <label>Message</label>
              <textarea name="message" class="form-control" id="message" placeholder="Send a message" required></textarea>
              </div>	
...
if(isset($_POST['submit'])){
    ...
    else if(!preg_match("/^[a-zA-z0-9]*$/",$phone)){
   echo"<script>alert('please enter only alphabets and numbers')</script>"; 
    ...
    echo "<script>alert('Submission Successful. Your forum member will get back to you')</script>";
