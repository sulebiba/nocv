...
<?php
    ...
    $quotephrase2=$rowquote2['quotephrase'];
        ...
        echo"<meta name= 'description' content='$quote2 Nigeria<br> <b>- $quotephrase2 Nigeria</b>'>";
    }
    }
...
<?php
    ...
    echo"<title>$nametitle in Nigeria</title>";   
    }
    }
...
<form class="form-inline active-cyan-4" method="post">
  <!--<input class="form-control form-control-sm mr-3 w-75" type="text" placeholder="e.g Lagos"
    ...
    $quotephrase=$rowquote['quotephrase'];
        ...
        echo"<p align='center'>$quote Nigeria<br> <b>- $quotephrase Nigeria</b></p>";  
    }
    }
...
$select=mysqli_query($db,"SELECT * FROM users WHERE skill='$type' ORDER BY rand() LIMIT 0,100")or die (mysqli_error($db));
while($row=mysqli_fetch_array($select)){
