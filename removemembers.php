...
<h3><b><font face='Algerian'>Click to remove Members</font></b></h3>
<hr>
<br>
<br>
<br>
...
if($bitch==$nocv_id){
$select=mysqli_query($db,"SELECT * FROM invites WHERE start_chat='$nocv_id' ORDER BY rand() LIMIT 0,500 ") or die(mysqli_error($db));
...
$select_user=mysqli_query($db,"SELECT * FROM users WHERE nocv_id='$nocv_id'") or die(mysqli_error($db));
    ...
    echo"  
<p><a href='profile.php?nocv_id=$ragner' class='btn btn-primary glyphicon glyphicon-user'>$name</a></p>
<p>$date</p>";

echo "
<p align='right'><a href='delete_members.php?id=$id' class='btn btn-danger glyphicon glyphicon-trash'>Remove</a></p>
<hr>";
}
 }
 }
